...
\newcommand{\showArt}{
\csname artsDef\romannumeral\directlua{
if artsList == nil then
    artsList = {}
end
if artsSeed == nil then
    artsSeed = 0
end
function mkArtsList()
    artsSeed = artsSeed + 17
    maxArts = \the\value{maxArts}
    math.randomseed(1111 + artsSeed*65536 + maxArts)
    for i = 1,maxArts do
        artsList[i] = i
    end
	for i = maxArts, 2, -1 do
		local j = math.random(i)
		artsList[i], artsList[j] = artsList[j], artsList[i]
	end
end
if artsList[1] == nil then
    mkArtsList()
end
tex.print(table.remove(artsList))
}\endcsname
}
